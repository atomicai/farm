    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        if pretrained_model_name_or_path in EMBEDDING_VOCAB_FILES_MAP["vocab_file"]:
            ...
            resolved_vocab_file = load_from_cache(
                pretrained_model_name_or_path, EMBEDDING_VOCAB_FILES_MAP["vocab_file"], **kwargs
            )
            ...
            temp = open(str(Path(pretrained_model_name_or_path) / "language_model_config.json"), "r", encoding="utf-8").read()
